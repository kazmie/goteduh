...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{route('admin-insurance-product-update-package')}}" method="POST">
            <input name="product_id" type="hidden" value="{{$product_id}}" class="form-control">
            <input name="id" type="hidden" value="{{$packages->id}}" class="form-control">
            @csrf
            <div class="row">
                <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input name="from_day" type="number" value="{{$packages->from_day}}" class="form-control" required>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <label>To Day</label>
                        <input name="to_day" type="number" value="{{$packages->to_day}}" class="form-control" required>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input name="price" type="text" value="{{$packages->price}}" class="form-control" required>
                    </div>
                </div>
            </div>
            <button type="submit" id="add-benefit" class="text-white btn btn-primary">Update</button>
        </form>
    </div>
</div>
@endsection
