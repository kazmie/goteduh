...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{route('admin-insurance-benefit-update')}}">

            @csrf
            <div class="md-col-12">
                <input name="id" type="hidden" value="{{$benefit->id}}" class="form-control">
                <div class="form-group">
                    <label for="inputText3" class="col-form-label">Benefit Name</label>
                    <input name="name" type="text" value="{{$benefit->name}}" class="form-control">
                </div>
