...
<div class="card">
    <div class="card-header">Edit New Product Category Plan</div>

    <div class="card-body">
        <form method="POST" action="{{route('admin-insurance-category-update')}}">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input name="category_name" value="{{ $item->category_name }}" type="text" class="form-control">
                        </div>                          
                    </div>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input id="color-input" name="color" type="text" value="{{ $item->color }}" class="form-control">
                        </div>                          
                    </div>
