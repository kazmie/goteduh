    ...
    <div class="page-breadcrumb">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="" class="breadcrumb-link">Insurance Region</a></li>
...
<div class="card">
    <div class="card-header">
        Add new Product Regions
    </div>
    <div class="card-body">
        @include('admin.layouts.notification')
        <form method="POST" action="{{route('admin-insurance-region-save')}}">
            @csrf
            <div class="row">
                <div class="col-md-5">
                    <label>Country</label>
                ...
                <div class="col-md-5">
                    ...
                    <select name="country_id[]" id="multiselect_to" class="form-control" size="8" multiple="multiple"></select>
                </div>
            </div>
            </br>
                <div class="row">
                ...
                <div class="col-md-2">
                    </br></br><button type="submit" id="add-benefit" class="text-white btn btn-primary" >Add</button>
                </div>
            </div>
        </form>
        <br><br>
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-xs btn-dark" href="/admin/region/edit/{{$item->id}}">Edit</a>
                        <a class="deleteRecord btn btn-xs btn-danger" data-id="{{ $item->id }}" id="delete"
                            href="#">Delete</a>
                    <a class="btn btn-xs btn-dark" href="/admin/region/duplicate/{{$item->id}}">Duplicate</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
